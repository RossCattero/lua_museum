...
function PANEL:CheckWorks()
    ...
    local worked = LocalPlayer():WorkInProgress();
    ...
    if !worked then
        ...
        self.jobName:SetText(LocalPlayer():GetJobName())
        ...
        self.jobPrice:SetText("Job price: " .. nut.currency.get(LocalPlayer():GetJobPrice()))
