...
--- Get certificate but it's ID
---@param uniqueID string (Name of certificate in list)
function ix.certifications.Get(uniqueID)
	return ix.certifications.list[uniqueID]
end;