...
local inventoryBackGround = Material( "materials/textures/inventory_image.png" )
local inventoryGrid = Material( "materials/textures/inventory_cell.png" )
...
function PANEL:Paint(width, height)
	...
	surface.SetMaterial( inventoryGrid )
...
function PANEL:Paint(w, h)
	...
	surface.DrawTexturedRect( -15, -25, w+20, h+30 )	
end;
