...
local backMat = Material("materials/textures/background.jpg")
...
surface.CreateFont( "StalkerFontLarge", {
	font = "RUSBoycott",
	extended = true,
	size = 60,
	weight = 500,
...
surface.CreateFont( "StalkerFont", {
	font = "RUSBoycott",
	extended = true,
	size = 30,
	weight = 500,
...
surface.CreateFont( "StalkerGraffitiFont", {
	font = "Graffiti1CTT",
	extended = true,
	size = 25,
	weight = 500,
...
surface.CreateFont( "StalkerGraffitiFontLittle", {
	font = "Graffiti1CTT",
	extended = true,
	size = 20,
	weight = 500,
...
local nameMaterialBackground = Material('materials/textures/char_name.png')

function SKIN:DrawCustomTextEntry(x, y, width, height, color)
	color = color or defaultBackgroundColor

	surface.SetDrawColor( color )
	surface.SetMaterial( nameMaterialBackground )
	surface.DrawTexturedRect( x, y, width, height )	
end
