...
ix.currency.singular = ix.currency.singular or "рубль"
ix.currency.plural = ix.currency.plural or "рублей"
ix.currency.model = ix.currency.model or "models/kek1ch/money_russia.mdl"
