...
do
	...
	---
	ix.flag.Add("P", "Доступ к команде новостей ПДА.")
	ix.flag.Add("Z", "Доступ к выдаче заданий в ПДА игрока.")
	ix.flag.Add("l", "Доступ к выдаче очков репутации и очков известности.")
end
