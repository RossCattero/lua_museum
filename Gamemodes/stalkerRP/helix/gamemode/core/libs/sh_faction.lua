...
for i = 1, 5 do
	ix.anim.SetModelClass("models/stalker_roleplay/lone/female_0"..i..".mdl", "citizen_female")
end;

for i = 1, 9 do
	table.insert(CITIZEN_MODELS, "models/stalker_roleplay/lone/male_0"..i..".mdl")
	ix.anim.SetModelClass("models/stalker_roleplay/lone/male_0"..i..".mdl", "citizen_male")
end;
