...
function Schema:UpdateCharacterInfo(panel)
	...
	if !panel.clothesList then
		panel.clothesList = panel:Add("PlayerClothes")
		panel.clothesList:Dock(TOP)
        panel.clothesList:DockMargin(0, 0, 0, 8)
        panel.clothesList:Populate()
	end;
end