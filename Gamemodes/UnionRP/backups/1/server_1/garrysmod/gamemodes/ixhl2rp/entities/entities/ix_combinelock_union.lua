...
ENT.Type = "anim"
ENT.PrintName = "Union Combine Lock"
ENT.Category = "HL2 RP"
ENT.Spawnable = true
ENT.AdminOnly = true
...
if (SERVER) then
	...
	function ENT:SpawnFunction(client, trace)
		...
		local entity = ents.Create("ix_combinelock_union")
	...
	function ENT:Toggle(client)
		...
		if (!client:GetCharacter():GetInventory():HasItem('union_lock_card') && client:Team() != FACTION_PARTY_BUREAU) then
			self:DisplayError()
	...
	local color_blue = Color(239, 226, 71, 255)
