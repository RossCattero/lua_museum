...
function meta:DoStaredAction(entity, callback, time, onCancel, distance, shouldCheck)
	...
	timer.Create(uniqueID, 0.1, time / 0.1, function()
		if (IsValid(self) and IsValid(entity)) then
			...
			if (util.TraceLine(data).Entity != entity or (shouldCheck && shouldCheck() == false)) then
