...
function PANEL:Rebuild()
	...
	if (#categories > 0 or #miscellaneous > 0) then
		...
		for k, v in pairs(miscellaneous) do
			...
			--categoryForm:SetMaterial("materials/attr.png")
		...
		local mat = Material("materials/attr.png");
...
function PANEL:Paint(w, h)
	...
	return draw.RoundedBox( 8, 0, 0, w, h, Color( 0, 0, 0, 150 ) );
end;
...
function PANEL:Init()
	...
	local fontName = Clockwork.fonts:GetSize(
		Clockwork.option:GetFont("menu_text_small"),
		size or 20
	);
