...
Clockwork.animation.holdTypes = {
	...
	["tfa_nmrih_bat"] = "blunt",
	["tfa_nmrih_etool"] = "blunt",
	["tfa_nmrih_fireaxe"] = "blunt",
	["tfa_nmrih_lpipe"] = "blunt",
	["tfa_nmrih_kknife"] = "blunt",
	["tfa_nmrih_sledge"] = "blunt",
	["tfa_nmrih_wrench"] = "blunt"
};
...
Clockwork.animation:AddRefugeeHands("ross");
...
Clockwork.animation:AddVortigauntModel("models/vortigaunt_ozaxi.mdl")
...
Clockwork.animation:AddCombineOverwatchModel("models/n7/cca/combine_commander.mdl");
Clockwork.animation:AddCombineOverwatchModel("models/n7/cca/harbinger_elite_soldier.mdl");
...
Clockwork.animation:AddMaleHumanModel("models/frp/metropolice/models/male_01.mdl");
Clockwork.animation:AddMaleHumanModel("models/frp/metropolice/models/male_02.mdl");
Clockwork.animation:AddMaleHumanModel("models/frp/metropolice/models/male_03.mdl");
Clockwork.animation:AddMaleHumanModel("models/frp/metropolice/models/male_04.mdl");
Clockwork.animation:AddMaleHumanModel("models/frp/metropolice/models/male_05.mdl");
Clockwork.animation:AddMaleHumanModel("models/frp/metropolice/models/male_06.mdl");
Clockwork.animation:AddMaleHumanModel("models/frp/metropolice/models/male_07.mdl");
Clockwork.animation:AddMaleHumanModel("models/frp/metropolice/models/male_08.mdl");
Clockwork.animation:AddMaleHumanModel("models/frp/metropolice/models/male_09.mdl");
Clockwork.animation:AddMaleHumanModel("models/frp/metropolice/models/male_10.mdl");
Clockwork.animation:AddMaleHumanModel("models/frp/metropolice/models/male_11.mdl");
Clockwork.animation:AddMaleHumanModel("models/frp/metropolice/models/male_12.mdl");
Clockwork.animation:AddMaleHumanModel("models/frp/metropolice/models/male_13.mdl");
Clockwork.animation:AddMaleHumanModel("models/frp/metropolice/models/male_14.mdl");
Clockwork.animation:AddMaleHumanModel("models/frp/metropolice/models/male_15.mdl");
Clockwork.animation:AddMaleHumanModel("models/frp/metropolice/models/male_16.mdl");
Clockwork.animation:AddMaleHumanModel("models/frp/metropolice/models/male_17.mdl");
Clockwork.animation:AddMaleHumanModel("models/frp/metropolice/models/neonlight.mdl");
Clockwork.animation:AddMaleHumanModel("models/frp/metropolice/models/quiet_police.mdl");
