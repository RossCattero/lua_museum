...
Clockwork.config:Add("health_regeneration_enabled", false);
Clockwork.config:Add("enable_prop_protection", true);
Clockwork.config:Add("use_local_machine_date", false, nil, nil, nil, nil, true);
Clockwork.config:Add("use_local_machine_time", true, nil, nil, nil, nil, false);
...
Clockwork.config:Add("default_inv_weight", 1, true);
Clockwork.config:Add("default_inv_space", 5, true);
...
Clockwork.config:Add("unrecognised_name", "Вы его не знаете.", true);
...
Clockwork.config:Add("default_cash", 30, nil, nil, nil, nil, nil, true);
...
Clockwork.config:Add("max_chat_length", 1000, true, true);
Clockwork.config:Add("cash_enabled", false, false, nil, nil, nil, false);
Clockwork.config:Add("default_physdesc", "", true);
Clockwork.config:Add("scale_chest_dmg", 1);
Clockwork.config:Add("body_decay_time", 600);
Clockwork.config:Add("banned_message", "Вы забанены на !t больше: !f.");
Clockwork.config:Add("wages_interval", 360);
Clockwork.config:Add("scale_prop_cost", 1);
Clockwork.config:Add("fade_dead_npcs", false, true);
...
Clockwork.config:Add("wages_name", "Зарплата", true);
...
Clockwork.config:Add("enable_space_system", true, true);
...
Clockwork.config:Add("description_crafting", "Combine various items to make new items.", false);
Clockwork.config:Add("crafting_menu_enabled", false, false);
