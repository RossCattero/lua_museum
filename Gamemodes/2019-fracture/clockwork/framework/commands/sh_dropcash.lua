...
local COMMAND = Clockwork.command:New("DropTokens");

COMMAND.tip = "Выбросить "..string.lower(NAME_CASH).." на позицию Вашего курсора.";
COMMAND.text = "<количество "..string.gsub(NAME_CASH, "%s", "")..">";
