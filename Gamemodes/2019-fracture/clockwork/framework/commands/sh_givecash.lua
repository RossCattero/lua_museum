...
local COMMAND = Clockwork.command:New("GiveTokens");

COMMAND.tip = "Дать "..string.lower(NAME_CASH).." персонажу, на которого смотрите.";
COMMAND.text = "<количетсво "..string.gsub(NAME_CASH, "%s", "")..">";
