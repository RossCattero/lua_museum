...
local COMMAND = Clockwork.command:New("SetTokens");

COMMAND.tip = "Установить количество "..string.lower(NAME_CASH).." персонажу.";
COMMAND.text = "<имя_персонажа> <количество "..string.gsub(NAME_CASH, "%s", "")..">";
