...
function THEME:CreateFonts()
	...
	{
		font		= "pfdintextpro-thin",
		size		= Clockwork.kernel:FontScreenScale(8.3),
		weight		= 700
	});
	...
	Clockwork.fonts:Add("cwMenuTextAshpalt", -- new
	{
		font		= "Capture it",
...
function THEME:Initialize()
	...
	Clockwork.option:SetFont("menu_text_asph", "cwMenuTextAshpalt");	
