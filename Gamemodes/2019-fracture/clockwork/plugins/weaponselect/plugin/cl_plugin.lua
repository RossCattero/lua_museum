...
function cwWeaponSelect:DrawWeaponInformation(itemTable, weapon, x, y, alpha)
	...
	or weapon.Instructions != ""))) then
		...
		if (weapon.InfoMarkup) then
			weapon.InfoMarkup:Draw(x + 100, realY + 63, nil, nil, alpha);
		end;
	end;
end;
