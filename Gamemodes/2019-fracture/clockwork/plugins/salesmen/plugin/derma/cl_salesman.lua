...
function PANEL:Init()
	...
	--self.settingsForm:SetDark(false);
    ...
    self.showChatBubble:SetTextColor( Color( 255, 255, 255 ) ) --self.:SetTextColor( Color( 255, 255, 255 ) )

	self.buyInShipments = self.settingsForm:CheckBox("Покупать вещи в x5-количестве (Отключайте).");
	self.buyInShipments:SetTextColor( Color( 255, 255, 255 ) )
    ...
    self.startHideName:SetBright( true )
    ...
    self.noSaleHideName:SetBright( true )
    ...
    self.noStockHideName:SetBright( true )
    ...
    self.needMoreHideName:SetBright( true )
	...
	self.cannotAffordHideName:SetBright( true )
	...
	self.doneBusinessHideName:SetBright( true )
