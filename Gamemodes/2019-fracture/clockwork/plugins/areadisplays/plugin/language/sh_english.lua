...
CW_ENGLISH["AreaDisplayRemoved"] = "You have successfully removed #1 area display(s).";
CW_ENGLISH["AreaDisplayAdded"] = "You have successfully added the '#1' area display.";
