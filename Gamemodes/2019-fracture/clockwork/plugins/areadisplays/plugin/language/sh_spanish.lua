...
CW_SPANISH["AreaDisplayRemoved"] = "Has eliminado un total de #1 área(s).";
CW_SPANISH["AreaDisplayAdded"] = "Has creado el área '#1'.";
CW_SPANISH["AreaDisplayMinimum"] = "Has añadido el punto mínimo, ahora añade el punto máximo.";
