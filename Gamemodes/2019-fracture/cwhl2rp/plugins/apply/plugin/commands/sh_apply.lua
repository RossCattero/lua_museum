...
function COMMAND:OnRun(player)
	...
	if (!Schema:PlayerIsCombine(player) and player:GetFaction() != FACTION_VORT and player:GetFaction() != FACTION_VORTSLAVE and player:GetFaction() != FACTION_REFUGEE and player:GetFaction() != FACTION_RESISTANCE and player:GetFaction() != FACTION_HOUNDEYE and player:GetFaction() != FACTION_RELEADER) then
