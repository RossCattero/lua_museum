...
function COMMAND:OnRun(player)
	...
	if (!Schema:PlayerIsCombine(player)) then
	    Clockwork.chatBox:AddInTargetRadius(player, "ic", "Меня зовут "..name..".", player:GetPos(), radius);
    else
	    Clockwork.chatBox:AddInTargetRadius(player, "ic", "Я юнит "..name..".", player:GetPos(), radius);
	end;
