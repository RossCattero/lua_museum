...
Clockwork.directory:AddCategory("HelpCombineDispatcher", "HelpCommands");
Clockwork.directory:AddCategory("HelpCivilProtection", "HelpCommands");
...
function Schema:AddCombineDisplayLine(text, color)
	if (self:PlayerIsCombine(Clockwork.Client) && Clockwork.Client:GetSharedVar("GasMaskInfo") >= 1) then
