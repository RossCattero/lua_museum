...
Clockwork.kernel:AddFile("resource/fonts/pfdintextpro-thin.ttf");
Clockwork.kernel:AddFile("resource/fonts/capture-it.ttf");
Clockwork.kernel:AddFile("resource/fonts/pfdintextpro-extrablack.ttf");
Clockwork.kernel:AddFile("resource/fonts/pfdintextcomppro-xthin.ttf");
Clockwork.kernel:AddFile("resource/fonts/pfdintextcondpro-bold.ttf");
Clockwork.kernel:AddFile("sound/usesound");
Clockwork.kernel:AddFile("usesound");
Clockwork.kernel:AddFile("serveri");
Clockwork.kernel:AddFile("materials/server/fracture.png");
Clockwork.kernel:AddFile("materials/server/fracture");
Clockwork.kernel:AddFile("server/fracture");
Clockwork.kernel:AddFile("server/fracture.png");
Clockwork.kernel:AddFile("materials/serveri/hardo.png");
Clockwork.kernel:AddFile("materials/serveri/");
Clockwork.kernel:AddFile("materials/hl2rp2/menuitems/classes.png");
Clockwork.kernel:AddFile("materials/hl2rp2/menuitems/settings.png");
Clockwork.kernel:AddFile("materials/hl2rp2/menuitems/system.png");
Clockwork.kernel:AddFile("materials/hl2rp2/menuitems/scoreboard.png");
Clockwork.kernel:AddFile("materials/hl2rp2/menuitems/inventory.png");
Clockwork.kernel:AddFile("materials/hl2rp2/menuitems/directory.png");
Clockwork.kernel:AddFile("materials/hl2rp2/menuitems/attributes.png");
Clockwork.kernel:AddFile("materials/hl2rp2/menuitems/business.png");
Clockwork.kernel:AddFile("materials/hl2rp2/menuitems/crafting.png");
Clockwork.kernel:AddFile("materials/hl2rp2/menuitems/plugincenter.png");
Clockwork.kernel:AddFile("materials/hl2rp2/menuitems/community.png");
Clockwork.kernel:AddFile("hl2rp2/themes/plain/large_dark.png");
Clockwork.kernel:AddFile("hl2rp2/infotext/red.png");
Clockwork.kernel:AddFile("hl2rp2/infotext/green.png");                  
Clockwork.kernel:AddFile("hl2rp2/infotext/orange.png");
Clockwork.kernel:AddFile("hl2rp2/infotext/blue.png");
Clockwork.kernel:AddFile("materials/hl2rp2/fracture_logo.png");
Clockwork.kernel:AddFile("server")
Clockwork.kernel:AddFile("materials/hl2rp2/attributes/acrobatics.png");
Clockwork.kernel:AddFile("materials/hl2rp2/attributes/agility.png");
Clockwork.kernel:AddFile("materials/hl2rp2/attributes/dexterity.png");
Clockwork.kernel:AddFile("materials/hl2rp2/attributes/endurance.png");
Clockwork.kernel:AddFile("materials/hl2rp2/attributes/medical.png");
Clockwork.kernel:AddFile("materials/hl2rp2/attributes/stamina.png");
Clockwork.kernel:AddFile("materials/hl2rp2/attributes/strength.png");
Clockwork.kernel:AddFile("materials/fracture_logo.png");
Clockwork.kernel:AddFile("materials/clockwork/hud.png")
Clockwork.kernel:AddFile("materials/edit")


Clockwork.kernel:AddDirectory("materials/models/lagmite/");
Clockwork.kernel:AddDirectory("materials/sur/")
Clockwork.kernel:AddDirectory("materials/edit/");
...
Clockwork.kernel:AddDirectory("addons/ns/sound/usesound/*.*");
Clockwork.kernel:AddDirectory("resource/fonts/*.*");
Clockwork.kernel:AddDirectory("materials/hl2rp2/menuitems/*.*");
Clockwork.kernel:AddDirectory("materials/hl2rp2/attributes/*.*");
Clockwork.kernel:AddDirectory("materials/serveri/");

Clockwork.config:Add("server_whitelist_identity", "");
Clockwork.config:Add("combine_lock_overrides", false);
Clockwork.config:Add("intro_text_small", "Удачного выживания...", true);
Clockwork.config:Add("intro_text_big", "Пустошь.", true);
Clockwork.config:Add("knockout_time", 60);
Clockwork.config:Add("business_cost", 160, true);
Clockwork.config:Add("cwu_props", false);
	...
	if (areaNames) then
		for k, v in pairs(areaNames.areaNames) do
			if (Clockwork.entity:IsInBox(player, v.minimum, v.maximum)) then
				if (string.sub(string.lower(v.name), 1, 4) == "") then
		...
		if (!completed) then
			if (closest) then
				if (string.sub(string.lower(closest[2]), 1, 4) == "") then
...
function Schema:TiePlayer(player, isTied, reset, combine)
	...
	if (isTied) then
		...
		Clockwork.kernel:PrintLog(LOGTYPE_GENERIC, player:Name().." связан(а).");
	...
	elseif (!reset) then
		...
		Clockwork.kernel:PrintLog(LOGTYPE_GENERIC, player:Name().." развязан(а).");
	end;
end;