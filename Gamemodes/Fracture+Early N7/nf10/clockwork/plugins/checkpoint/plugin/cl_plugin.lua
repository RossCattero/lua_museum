...
Clockwork.chatBox:RegisterClass("cp_unapprovedplayer", nil, function(info)
	Clockwork.chatBox:Add(info.filtered, "icon16/new.png", PLUGIN.color, "[CP] ", info.data.color, info.text, " (OOC: ", info.data.ooc, ") появился.");
end);
...
Clockwork.chatBox:RegisterClass("cp_connect", nil, function(info)
	...
	Clockwork.chatBox:Add(filtered, "icon16/"..icon..".png", Color(233, 165, 22, 255), info.text.." подключился к серверу.");
end);
