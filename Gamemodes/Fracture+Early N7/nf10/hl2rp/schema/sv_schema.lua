...
Clockwork.kernel:AddDirectory("models/frp/");

Clockwork.kernel:AddFile("resource/fonts/cbold.ttf");
Clockwork.kernel:AddFile("resource/fonts/longshot.ttf");
Clockwork.kernel:AddFile("resource/fonts/swcrawl.ttf");
Clockwork.kernel:AddFile("materials/edit");

Clockwork.kernel:AddFile("sound/usesound");
-- Clockwork.kernel:AddFile("materials/effects/muzzleflash2edit.vtf")
-- Clockwork.kernel:AddFile("materials/effects/muzzleflash2edit.vmt")
Clockwork.kernel:AddFile("materials/fracture_logo.png");
Clockwork.kernel:AddFile("materials/poing.vtf");
Clockwork.kernel:AddFile("materials/poing.vmt");
Clockwork.kernel:AddFile("materials/hud_cpmask.png");
Clockwork.kernel:AddFile("materials/paper.jpg");
Clockwork.kernel:AddFile("materials/lungsicon3.png");

Clockwork.config:Add("server_whitelist_identity", "");
Clockwork.config:Add("combine_lock_overrides", false);
Clockwork.config:Add("intro_text_small", "Добро пожаловать в город.", true);
Clockwork.config:Add("intro_text_big", "City 18 / 2019.", true);
...
function Schema:TiePlayer(player, isTied, reset, combine)
	...
	if (isTied) then
		...
		Clockwork.kernel:PrintLog(LOGTYPE_GENERIC, player:Name().." был связан.");
	...
	elseif (!reset) then
		...
		Clockwork.kernel:PrintLog(LOGTYPE_GENERIC, player:Name().." был развязан.");
	end;
end;
