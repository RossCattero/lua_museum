...
Clockwork.datastream:Hook("SalesmanAdd", function(data)
	...
	Derma_StringRequest("Имя", "Какое имя Вы хотите установить данному продавцу?", "", function(text)
		Clockwork.salesman.name = text;
		
		gui.EnableScreenClicker(true);
		
		Clockwork.salesman.showChatBubble = false;
		Clockwork.salesman.buyInShipments = false;
...
Clockwork.datastream:Hook("SalesmanEdit", function(data)
	...
	Derma_StringRequest("Имя", "Какое имя Вы хотите установить данному продавцу?", data.name, function(text)
