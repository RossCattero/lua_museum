...
function ITEM:OnUse(player, itemEntity)	
	...
	if table.HasValue(self.WeaponsCanUse, weaponact:GetClass()) && weaponact.Primary.Ammo == self:GetData("AmmoType") && !weapon:GetData("Mag") && (!player.reloadING || CurTime() >= player.reloadING) then
