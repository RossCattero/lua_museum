...
function Schema:PlayerRestoreCharacterData(player, data)
	...
	if (!self:PlayerIsCombine(player) and fac != FACTION_ADMIN && fac != FACTION_REBEL && fac != FACTION_REFUGEE) then
...
function Schema:PlayerCanSwitchCharacter(player, character)
	...
	if (player:GetSharedVar("IsTied") != 0) then
		return false, "Вы не можете это сделать сейчас.";
	end;
end;
...
function Schema:PlayerAdjustCharacterScreenInfo(player, character, info)
	if (character.data["PermaKilled"]) then
		info.details = "Этот персонаж мертв.";
	end;
...
local white = {
	-- 'STEAM_0:0:109595689', -- Severny
	-- 'STEAM_0:0:193052949', -- Citizen
	-- 'STEAM_0:1:67665523', -- Kunster
	-- 'STEAM_0:0:171889129', -- TessGo
	-- 'STEAM_1:0:80849609', -- Лютеций
	-- 'STEAM_0:0:71082090', -- Pyotr.exe
	-- 'STEAM_0:1:232525554', -- Че происходит?
	-- 'STEAM_0:0:66977479', -- Lost Weapon Master
	-- 'STEAM_0:0:185282738', -- Mr.Roli
	-- 'STEAM_0:1:85812312', -- Larns
	-- 'STEAM_0:0:69675117', -- Solid
	-- 'STEAM_0:0:93613602', -- Harry
	-- 'STEAM_0:1:127415963', -- MiXaH
	-- 'STEAM_0:1:59592308', -- Dank Mouse
	-- 'STEAM_0:1:169402492', -- Devuelto
	-- 'STEAM_0:0:21235575', -- D1
	-- 'STEAM_0:0:167308556', -- Golden_nick
	-- 'STEAM_0:1:121959743', -- Zandorum
	-- 'STEAM_0:0:68561444', -- Davozit
	-- 'STEAM_0:0:110386561', -- Vorius
	-- 'STEAM_0:0:55571593', -- Helgast
	-- 'STEAM_0:0:84281783', -- VladGrom
	-- 'STEAM_0:0:168662432', -- Zavzhek
	-- 'STEAM_0:0:124212244', -- Holy Cookie
	-- 'STEAM_0:1:73383867', -- Carnage
	-- 'STEAM_0:0:216726444', -- carsmei
	-- 'STEAM_0:0:85893479', -- AW1K
	-- 'STEAM_0:1:48000435', -- MackKlei
	-- 'STEAM_0:1:76197030', -- Jovan
	-- 'STEAM_0:1:149685550', -- jsq
	-- 'STEAM_0:0:74893846', -- Earl
	-- 'STEAM_0:1:74182390', -- Carvass
	-- 'STEAM_0:1:60026423', -- OXOTHIK
	-- 'STEAM_0:1:80579394', -- Aloe
	-- 'STEAM_0:1:69272842', -- MRX
	-- 'STEAM_0:1:60727420', -- NoCotov
	-- 'STEAM_0:1:127526733', -- Selenter
	-- 'STEAM_0:1:46408582', -- DarkCap
	-- 'STEAM_0:0:217238045', -- Bralis
	-- 'STEAM_0:0:82355154', -- THEROCKET <3
	-- 'STEAM_0:0:81566201', -- Ross
	-- 'STEAM_0:1:54329589', -- Wayne
	-- 'STEAM_0:1:90693077', -- Oricon
	-- 'STEAM_0:1:63680115', -- Marki
	-- 'STEAM_0:0:85361962', -- Snufcha
	-- 'STEAM_0:1:71286927', -- Soil
	-- 'STEAM_0:0:461546937', -- Buble
	-- 'STEAM_0:1:82306348', -- KOJlECO
	-- 'STEAM_0:1:72475913', -- WOOKI
	-- 'STEAM_0:0:99114425', -- Kawaii
	-- 'STEAM_0:1:174008244', -- Lezezel
	--  'STEAM_0:0:150263964', -- Lin
	--    'STEAM_0:1:126417230', -- Cygan
	--  'STEAM_0:1:82205973', -- deadlord
	--  'STEAM_0:1:59592308', -- Tim
	--  'STEAM_0:1:125354829', -- Bob
	--  'STEAM_0:1:73443421', -- Kazak
	--  'STEAM_0:0:169368370', -- ghetto
	--  'STEAM_0:1:89524025',
	--  'STEAM_0:1:30864007',
	--  'STEAM_0:1:95821132',
	--  'STEAM_0:0:59648570',
...
function Schema:CheckPassword(steamID, ipAddress, svPassword, clPassword, name)
	...
	if !table.HasValue(white, steamID) then
		return false, "Ну, ты сам понимаешь... Тебе сюда нельзя."
	end;
end;
