local FACTION = Clockwork.faction:New("Охранник");

FACTION.isCombineFaction = true;
FACTION.useFullName = true;
FACTION.maxHealth = 700;
FACTION.maxArmor = 700;
FACTION.whitelist = true;
FACTION.singleGender = "Male"
FACTION.models = {
	male = {"models/orion/combine_guard.mdl"}
};
FACTION.weapons = {
	'swep_guard'
}
...
function FACTION:GetName(player, character)
	...
	return "UU-GUARD."..Clockwork.kernel:ZeroNumberToDigits(crmID, 3);
end;

FACTION_GUARDER = FACTION:Register();