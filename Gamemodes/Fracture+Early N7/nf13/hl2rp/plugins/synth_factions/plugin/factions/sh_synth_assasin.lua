local FACTION = Clockwork.faction:New("Ассасин");
...
function FACTION:GetName(player, character)
	...
	return "UU-ASSASIN."..Clockwork.kernel:ZeroNumberToDigits(crmID, 3);
end;

FACTION_ASSASIN = FACTION:Register();